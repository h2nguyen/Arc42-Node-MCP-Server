...
The **Arc42 Node MCP Server** is a Model Context Protocol (MCP) server that enables AI assistants to create comprehensive architecture documentation using the proven arc42 template.
...
| FR-9 | Multi-language template support (11 languages)                | Should   |
...
- Limited to a single language, hindering global teams
...
| 6        | **Internationalization** | Support documentation in multiple languages to serve global development teams                 |
...
| **Global Teams**          | International development teams               | Documentation templates in their native language               |
